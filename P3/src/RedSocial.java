...
public class RedSocial {
    ...
    RedSocial(String filenameUsuarios, String filenameEnlaces, String filenameMensaje) throws NullPointerException,
        ...
        Mensaje m = this.mensajes.toArray(new Mensaje[0])[0];
    ...
    private void leerUsuarios(String filenameUsuarios) throws IOException {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                words = line.split("[\\t ]+"); /* Acepta espacios y tabuladores como regex :) */
    ...
    private void leerMensaje(String filenameMensaje) throws IOException {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                words = line.split("[\\t ]+"); /* Es para que borre los espacios extra detrás del nombre */
                nombreUsuario = words[0];
     ...
     */
    public void addEnlace(String nombreUsuarioOrigen, String nombreUsuarioDestino, int coste) throws
     ...
     */
    public void addMessageReceivers(String texto, int alcanceDisp, String autor, String... nombreUsuariosDest) throws
            NullPointerException {
