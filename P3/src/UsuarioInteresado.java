...
public class UsuarioInteresado extends Usuario{
    ...
    /**
     * Constructor para un usuario interesadp
    ...
    /**
     * Devuelve el primer enlace que conecte con un usuario de exposicion alta o mayor, y si no hay ninguno el primer enlace que tenga el usuario destino que se pide
