...
public class PersonFeaturizer implements Featurizer<Person> {
     ...
     * @param person the object is going to show the features
     * @return An objet with all the features from the object
     */
    @Override
    public Object importantFeatureValues(Person person) {
        return person.getName() + "(age: " + person.getAge() + ", " + person.getGender().toLowerCase() + ")";
    }
